		...
		<SectionHomePage id="section-home">
			...
			<LandingPageContainer>
				<TitleLandingContainer>
					...
					<TypeAnimation sequence={[language.landingPage.name, 5000, "jo4er", 5000]} speed={50} className="type-string" repeat={Infinity} />
					<SubTitleLanding>
						{language.landingPage.resumeText &&
							language.landingPage.resumeText.split("\n").map((line, idx) => (
								<p key={idx} style={{ margin: idx === 2 ? "0.8rem 0 0 0" : "0" }}>
									{line}
								</p>
							))}
					</SubTitleLanding>
